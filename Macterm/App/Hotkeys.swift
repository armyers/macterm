...
enum HotkeyAction: String, CaseIterable, Identifiable {
    ...
    var defaultShortcut: String {
        ...
        case .recentContext: "cmd+shift+o"
        ...
        case .openContext: "cmd+shift+p"
        case .zoomPane: "cmd+shift+return"
        case .editScrollback: "cmd+shift+e"
